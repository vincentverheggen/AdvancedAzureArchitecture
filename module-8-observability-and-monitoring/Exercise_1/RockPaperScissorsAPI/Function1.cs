...
namespace RockPaperScissorsAPI
{
    public static class Function1
    {
         ...
         ILogger log)
        {
            ...
            string appInsights = Environment.GetEnvironmentVariable("INSIGHTS_CONNECTION_STRING") ?? "";
            return new OkObjectResult(new { GameApiUrl = gameApiUrl, APIMUrl = apimUrl, ApplicationInsightsConnectionString = appInsights });
        }
    }
}
