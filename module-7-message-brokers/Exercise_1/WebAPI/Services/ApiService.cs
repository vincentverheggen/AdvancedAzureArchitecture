...
namespace GameAPI.Services
{
    ...
    {
        Task<T> GetAsync<T>(string apiFunction, string client = "BOT");
        Task<T> PostAsync<T>(string apiFunction, object data, string client = "BOT");
    ...
    public class ApiService : IApiService
    {
        ...
        public async Task<T> GetAsync<T>(string apiFunction, string client = "BOT")
        {
            T tResult = default(T);
        ...
        public async Task<T> PostAsync<T>(string apiFunction, object data, string client = "BOT")
        {
            T tResult = default(T);
            var http = _httpClientFactory.CreateClient(client);
