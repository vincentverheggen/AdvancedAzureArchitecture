...
namespace RockPaperScissorsAPI
{
    public static class Function1
    {
         ...
         ILogger log)
        {
            ...
            string botApiUrl = Environment.GetEnvironmentVariable("BOTAPI_URL") ?? "http://localhost:5080";
            return new OkObjectResult(new { GameApiUrl = gameApiUrl, BotApiUrl = botApiUrl });
        }
    }
}
